...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Tuyết Tuyết đáng iu của anh!";
    let charArrTitle = textTitle.split('');
let text = "Giáng sinh này anh đã có em! Chúc bạn gái anh yêu luôn được hạnh phúc, xinh đẹp, ngoan ngoãn hơn nhíe. Mãi iuuuu emmmmm ❤"
